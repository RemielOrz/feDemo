...
define(["OE","Menu","lazyload","_","Loading","Swipe","AsideWindow"],function(OE,Menu,lazyload,_,Loading,Swipe,AsideWindow){
    ...
    var times = 1;
    function fn(){
        OE.log('Page:[city list], Times:' ,times++);
        Loading.hide();
        $.get(OE.BASE_URL+'/template/trip/tpl_destination_city_list.html', function(html){
            console.log('template [tpl_destination_city_list.html] onload');
            var $html = $(html);
