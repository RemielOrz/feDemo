/**
 * @license AngularJS v1.2.4-5a8d9ac
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-5a8d9ac/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-5a8d9ac',    // all of these placeholder strings will be replaced by grunt's
